...
There	are	many	implementations of	Python
 ...
 - `PyPy` - Python interpreter with a Just‑In‑Time (JIT) compiler. can run many Python programs significantly faster than CPython because of its JIT compiler
...
---
chooose the kernel(kernel is essentially the interpreter that runs your Jupyter Notebook code)from the virtual environment you have created.

<img width="464" height="156" alt="2" src="https://github.com/user-attachments/assets/c6d8ee72-39ad-4909-a4f5-bfe342561bac" />
